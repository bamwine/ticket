...
class Email_model extends CI_Model { 
	...
	function notify_email($task = '' , $param2 = '' , $param3 = '' , $param4 = '' , $param5 = '')
    {
    	...
    	if ($task == 'new_staff_account_opening')
    	{
    		...
    		$STAFF_NAME		=	$this->db->get_where('teacher' , array('staff_id' => $staff_id))->row()->name;
    		$STAFF_EMAIL	=	$this->db->get_where('teacher' , array('staff_id' => $staff_id))->row()->email;
    		$SYSTEM_URL		=	base_url();
     ...
     /*   if ($task == 'support_ticket_assign_staff')
        {
            ...
            $email_to       =   $this->db->get_where('teacher' , array('staff_id' => $staff_id))->row()->email;
            $this->do_email($email_msg , $email_sub , $email_to);
        }
		*/
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"https://generationatech.com</a></center>";
