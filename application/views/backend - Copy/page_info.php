...
<a href="#" data-toggle="modal" data-target="#modalPush" target="_blank" class="btn btn-info btn-sm pull-right m-l-20 btn-rounded hidden-xs hidden-sm waves-effect waves-light" style="color:white"><i class="fa fa-globe"></i>&nbsp;Your License </a>
<li class="active">
<script>
