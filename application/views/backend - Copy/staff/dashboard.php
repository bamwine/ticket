	 ...
	 <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4><strong style="color:white">FLIGHTS</strong></h4>
                                    <span class="text-muted"><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/flightschedule" style="color:white">
<?php echo get_phrase('schedule');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                <i class="fa fa-plane bg-danger"></i>
                                <div class="bodystate">
                                    <h4><strong style="color:white">AIR CRAFTS </strong></h4>
                                    <span class="text-muted"><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/flightaircrafts" style="color:white">
<?php echo get_phrase('details ');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
			 ...
			 <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                <i class="fa fa-plane bg-danger"></i>
                                <div class="bodystate">
                                    <h4><strong style="color:white">FLIGHT ROUTES</strong></h4>
                                    <span class="text-muted"><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/flightroutes" style="color:white">
<?php echo get_phrase('details');?></a></span>
                                </div>
                            </div>
                        </div>
					...
					<div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                <i class="fa fa-plane bg-danger"></i>
                                <div class="bodystate">
                                    <h4><strong style="color:white">BOOKINGS</strong></h4>
                                    <span class="text-muted"><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/bookings" style="color:white">
<?php echo get_phrase('details ');?></a></span>
                                </div>
                            </div>
                        </div>
					...
					<div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                <i class="fa fa-plane bg-danger"></i>
                                <div class="bodystate">
                                    <h4><strong style="color:white">DESTINATION</strong></h4>
                                    <span class="text-muted"><a href="<?php echo base_url(); ?><?php echo $account_type; ?>/flight_destination" style="color:white">
<?php echo get_phrase('details ');?></a></span>
                                </div>
                            </div>
                        </div>
...
<button class="btn btn2 btn-info btn-rounded submit" name="submit"><i class="fa fa-envelope"></i></button>
				...
				<!--<div id="notice_calendar"></div>-->
					...
					<div class="col-md-6 col-lg-6">
				  	<div class="panel panel-info">
                    <div class="panel-heading"><i class="fa fa-calendar"></i>&nbsp;<?php echo get_phrase('company_event');?></div>
