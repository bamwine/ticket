<!-- .chat-row -->
                ...
                <div class="col-sm-8">
                  ...
                  <a href="<?php echo site_url('staff/group_message/group_message_read/'.$row['group_message_thread_code']); ?>" class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['group_message_thread_code']) echo 'active'; ?>">
...
<a href="#" class="customize_group" onclick="showAjaxModal('<?php echo site_url('modal/popup/group_info/'.$row['group_message_thread_code']);?>');">view</a>
                    ...
                    <div class="chat-right-aside">
                        <div class="chat-main-header">
							...
							<strong> <?php echo get_phrase('Group Name:');?></strong>&nbsp;<?php echo $this->db->get_where('group_message_thread', array('group_message_thread_code' => $current_message_thread_code))->row()->group_name; ?>
                              
						<div class="btn-group pull-right">
                        <button class="btn btn-small btn-outline" data-toggle="dropdown"> <i class="icon-options-vertical"></i></button>
                        <ul class="dropdown-menu">
						<li> <a href="<?php echo base_url(); ?>staff/message"> 
						 <?php echo get_phrase('Personal Message');?>
               
            			</a></li>
						
						<li><a href="<?php echo base_url(); ?>staff/message/message_new">
                		
						 <?php echo get_phrase('Send New Chat');?>
								...
								<li class="odd">
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text" style="border:-moz-border-radius: 1em 4em 1em 4em;border-radius: 1em 4em 1em 4em;display:inline-block;">
											...
											<a href="#" onclick="confirm_modal('<?php echo base_url();?>staff/deleteMessageFunctionGroup/<?php echo $row['group_message_id'];?>/<?php echo $row['group_message_thread_code'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
		 				...
		 				<div class="alert alert-info"> <?php echo get_phrase('No message thread here. Type message to compose new message for group members to see. Thanks ');?></div>
 		 				<?php endif; ?>
                            ...
                            <div class="row send-chat-box"> 
                                <div class="col-sm-12"> 
                                    ...
                                    <div class="custom-send pull-left">
                                        <button class="btn btn2 btn-info btn-rounded submit" name="submit"><i class="fa fa-envelope"></i> <?php echo get_phrase('Send');?></button>
									<?php echo form_close(); ?> 
                                    </div>
                                </div>
                            </div>
...
jQuery.ajax({
type: "POST",
url: "<?php echo base_url(); ?>" + "staff/group_message/send_reply/<?php echo $current_message_thread_code?>",
dataType: 'json',
