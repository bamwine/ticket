<div class="row">
                ...
                foreach ($edit_data as $row):
                    ?>
                    <?php echo form_open(base_url() . 'staff/manage_profile/update_profile_info', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
					...
					<div class="form-group"> 
					 ...
					 <img id="" src="<?php echo $this->crud_model->get_image_url('staff', $row['staff_id']); ?>" alt="" height="200" width="200"/>
					</div>
					</div>	
...
<div class="panel-wrapper collapse in" aria-expanded="true">
                ...
                foreach ($edit_data as $row):
                    ?>
                    <?php echo form_open(base_url() . 'staff/manage_profile/change_password', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
