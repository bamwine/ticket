<!-- .chat-row -->
                ...
                ?>
                                ...
                                <li>
<a href="<?php echo base_url(); ?>staff/message/message_read/<?php echo $row['message_thread_code']; ?>"><img src="<?php echo $this->crud_model->get_image_url($user_to_show_type, $user_to_show_id); ?>" class="img-circle" draggable="false"/> <span><?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->name; ?>
<small class="text-success">
                    ...
                    <div class="chat-right-aside">
                        <div class="chat-main-header">
							...
							<?php echo get_phrase('Chat Message');?>
