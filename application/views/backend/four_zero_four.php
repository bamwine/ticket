...
<head>
    ...
    <meta name="author" content="<?php echo base_url();?>OAKSOFT TECHNOLOGIES">
	<?php include 'includes.php'; ?>
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>optimum/plugins/images/favicon.png">
    <title>Error Page <?php echo $system_title = $this->db->get_where('settings', array('type' => 'system_title'))->row()->description; ?></title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- color CSS -->
    <link href="<?php echo base_url();?>optimum/css/colors/default.css" id="theme" rel="stylesheet">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">YOU SEEMS TO BE TRYING TO FIND HIS WAY HOME</p>
                <a href="<?php echo base_url();?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
            <footer class="footer text-center"><?php echo $footer = $this->db->get_where('settings', array('type' => 'footer'))->row()->description; ?></footer>
        </div>
    </section>
