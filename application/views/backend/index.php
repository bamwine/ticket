  ...
  <div class="modal-dialog modal-notify modal-info" role="document">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-body">
        ...
        <h5><strong style="color:red">Purchase Notice:</strong>&nbsp;Thanks for downloading ONLINE BOOKING AND E-TICKET SYSTEM
		
		<hr>
		This is ONLINE BOOKING AND E-TICKET SYSTEM, the software allows you to manage all the airline activities. The purpose of this software you have downloaded is for you to be aware of this great airline. Please note that you need to purchase this software so as for you to have all access features.<br> This airline system has attractive landing page with result checker with PINs and serial number, student can also register from the landing page and it will be approved by the admin, the airline has barcode, camera attendace and many more. For more info email to <a href="mailto:oaksofto@gmail.com"> Support Center</a>
		<hr>
		<a href="https://generationatech.com" target="_blank" class="btn btn-info btn-sm pull-right m-l-20 btn-rounded hidden-xs hidden-sm waves-effect waves-light" style="color:white"><i class="fa fa-globe"></i>&nbsp;Purchase Now</a><a href="https://generationatech.com" target="_blank" class="btn btn-primary btn-sm pull-right m-l-20 btn-rounded hidden-xs hidden-sm waves-effect waves-light" style="color:white"><i class="fa fa-globe"></i>&nbsp;Online Demo</a>
      </div>
