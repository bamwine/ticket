...
<div class="col-md-3 col-sm-6">
	<div class="white-box bg-danger">
		<div class="r-icon-stats">
			...
			<div class="bodystate">
				<h4><strong style="color:white"><?php echo get_phrase('FLIGHTS');?></strong></h4>
...
<div class="col-md-3 col-sm-6">
	<div class="white-box bg-danger">
		<div class="r-icon-stats">
			<i class="fa fa-plane bg-danger"></i>
			<div class="bodystate">
				<h4><strong style="color:white"> <?php echo get_phrase('BOOKINGS');?></strong></h4>
...
<div class="col-md-3 col-sm-6">
	<div class="white-box bg-success">
		<div class="r-icon-stats">
			...
			<div class="bodystate">
				 <h4><strong style="color:white"><?php echo get_phrase('TICKETS');?></strong></h4>
