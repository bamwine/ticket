...
<div class="form-group">
	<label class="col-md-12" for="example-text"><?php echo get_phrase('TICKET PRICE ('.$row2['name'].')PACKAGE');?></label>
	<div class="col-sm-12">

	<input type="number" name="price<?php echo $row2['class_id']?>" value="<?php echo $this->crud_model->get_flights_types_price($row2['class_id'],$row['flight_no']);?>"  class="form-control "  required>
...
<div class="form-group">
	<label class="col-md-12" for="example-text"><?php echo get_phrase('NUMBER OF SEATS IN ('.$row2['name'].' PACKAGE)');?></label>
	<div class="col-sm-12">

	<input type="number" name="seats<?php echo $row2['class_id']?>" value="<?php echo $this->crud_model->get_flights_types_seats($row2['class_id'],$row['flight_no']);?>" class="form-control "  required>
