<!-- .chat-row -->
	...
	<div class="row">
				...
				<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['group_message_thread_code']) echo 'active'; ?>
                  <a href="<?php echo site_url('staff/group_message/group_message_read/'.$row['group_message_thread_code']); ?>">
				...
				<div class="col-sm-4">
<a href="#" class="customize_group" onclick="showAjaxModal('<?php echo site_url('modal/popup/group_info/'.$row['group_message_thread_code']);?>');"><?php echo get_phrase('view');?></a>
                </div>
				</div>
                                </li>
               ...
               <?php echo get_phrase('Persinal Chat');?>
            			</a></li>
