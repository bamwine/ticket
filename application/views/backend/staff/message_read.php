...
<a href="<?php echo base_url(); ?>staff/message/message_read/<?php echo $row['message_thread_code']; ?>" class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active';?>"><img src="<?php echo $this->crud_model->get_image_url($user_to_show_type, $user_to_show_id); ?>" class="img-circle" draggable="false"/> <span><?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->name; ?><small class="text-success">
                    ...
                    <div class="chat-right-aside">
                        <div class="chat-main-header">
                            <div class="p-20 b-b">
								<span > <?php echo get_phrase('You are currently online');?><i class="fa fa-circle" style="color: #00a651; pull-right"></i></span>
							   
							  <div class="btn-group pull-right">
                        <button class="btn btn-small btn-outline" data-toggle="dropdown"> <i class="icon-options-vertical"></i></button>
                        <ul class="dropdown-menu">
						<li> <a href="<?php echo base_url(); ?>staff/group_message"> 
						
                <?php echo get_phrase('Group Chat');?>
            			</a></li>
								...
								<li class="odd">
                                    ...
                                    <div class="chat-body">
                                        <div class="chat-text" style="border:-moz-border-radius: 1em 4em 1em 4em;border-radius: 1em 4em 1em 4em;display:inline-block;">
											...
											<a href="#" onclick="confirm_modal('<?php echo base_url();?>staff/deleteMessageFunction/<?php echo $row['message_id'];?>/<?php echo $row['message_thread_code'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
...
jQuery.ajax({
type: "POST",
url: "<?php echo base_url(); ?>" + "staff/message/send_reply/<?php echo $current_message_thread_code?>",
dataType: 'json',
