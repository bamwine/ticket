...
foreach ($edit_data as $row):
    ...
    <?php echo form_open(base_url() . 'staff/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
				   ...
				   <div align="center">
		<img src="<?php echo $this->crud_model->get_image_url('staff' , $row['staff_id']);?>" class="img-circle" width="100" height="100" />
		</div>
		...
		<div class="form-group">
                    ...
                    <div class="col-sm-12">
      					...
      					<input type="hidden" class="form-control" name="reciever"  value="staff-<?php echo $row['staff_id']; ?>" readonly="true">
