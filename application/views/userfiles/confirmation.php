...
<?php include 'navigation.php';?>
					...
					<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 tckt-prv"><span id="ticketPreviewError">
						...
						<div class="panel panel-default tppp ticket__prev__summary">
							...
							<div class="pass__flight__summary__heading col-lg-12 col-sm-12 col-md-12 ">
								<h3 class="panel-title tppt pass__flight__summary__title" style="float:left;">
								<i class="flaticon-flight-info flight__info__icon"></i>Flight  confirmed
		...
		<!--- MOBILE -->
			...
			<div class="unique-flight accordion">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding summary-body segment__body">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3><b>YOUR TICKET</b> <span class="pull-right">#TKT-2019015140</span></h3>
                            <hr>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left"> 
				<address>
                  <h3> &nbsp;<b class="text-danger">AIR JUBA COMPANY</b></h3>
                  <p class="text-muted m-l-5">Location:&nbsp;&nbsp;JUBA AIRPORT ,, <br>
                    Email:&nbsp;&nbsp;info@airjuba,com, <br>
                    Tel:&nbsp;&nbsp;+112 345 567 67,, <br>
                    </p>
                  </address>
  ...
  <p>
	 ...
	 <address>
	  ...
	  <p>
	    <b>DEPARTURE:</b>&nbsp;&nbsp;ENTEBBE&nbsp;&nbsp;&nbsp;&nbsp;<span><b>DEPARTURE TIME:</b>&nbsp;&nbsp;22:00:00</span> <br>
		<b>DESTINATION :</b>&nbsp;&nbsp;WAU&nbsp;&nbsp;&nbsp;&nbsp;<span><b>ARRIVAL  TIME:</b>&nbsp;&nbsp;08:00:00</span> <br>
		
		</p>
		<p><b>AIR CRAFT NO  :</b>  10002-Airbus A380</p>
...
<p></p>				  
				...
				<div class="pull-right ">
                  ...
                  <h4 class="font-bold">albert</h4>
                  <b>FARE PRICE :</b>  1200&nbsp;USD<p></p>                  
				  <p><b>TRAVEL DATE :</b>  2020-02-20</p>
				  <p><b>FLIGHT NUMBER :</b>FLT20200838137966</p>
				   <p><b>CLASS TYPE:</b>  business</p>
	...
	<p class="row">				
<button onClick="printPDF();" class="btn btn-default btn-outline" type="button"> <span><i class="fa fa-print"></i> Download Your Ticket</span> </button>
<button onClick="printPDF();" class="btn btn-default btn-outline" type="button"> <span><i class="fa fa-print"></i> Download Your Recipt</span> </button>
